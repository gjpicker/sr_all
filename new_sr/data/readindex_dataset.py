...
class TrainDatasetFromFolder(data.Dataset):
    def __init__(self, image_index_path, is_gray=False, random_scale=True, crop_size=296, rotate=True, fliplr=True,
                 fliptb=True, scale_factor=4,is_normlize=True):
...
#             lr, hr, lr_img_h, self.scale)
        ...
        return {"lr":lr_img, "hr":hr_img,\
            "cubic":bc_img ,"lr3" :lr_img_3, "lr2": lr_img_2 }
...
class TestDatasetFromFolder(TrainDatasetFromFolder):
    def __init__(self, image_index_path, is_gray=False, random_scale=True, crop_size=296, rotate=True, fliplr=True,
        ...
        super().__init__(image_index_path,is_gray,random_scale,crop_size,rotate,fliplr,fliptb,scale_factor,is_normlize)
