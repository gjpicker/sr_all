...
def define_net(opt):
    ...
    if which_model == 'DBPN':
    ...
    elif which_model.lower()=="carn":
        kwargs = {
        "group": 1,
        "multi_scale": True,
        "scale": 0,
        }
        from .carn_arch import Net as g1_net 
        net= g1_net(**kwargs)
    elif which_model.lower()=="carnm":
        from .carnm_arch import Net as g2_net 
        kwargs = {
        "group": 4,
        "multi_scale": True,
        "scale": 0,
        ...
        net= g2_net(**kwargs)
        print (netG)
    elif which_model.lower()=="pcarn":
        from .pcarn_arch import Net as g1_net 
        kwargs = {
            "num_channels": 64,
            "groups": 1,
            "mobile": False,
